...
__choose_child(_RandomAccessIterator& __left,
               ...
               __iter_diff_t<_RandomAccessIterator> __boundary,
               _Compare&& __comp) {
  if (__assume_both_children || __pos < __boundary) {
...
__sift_down(_RandomAccessIterator __first,
  ...
  std::__choose_child<_AlgPolicy, __assume_both_children>(__child_i, __child, __len - 1, __comp);
...
__floyd_sift_down(_RandomAccessIterator __first, _Compare&& __comp, __iter_diff_t<_RandomAccessIterator> __len __len) {
  ...
  while (__child <= __len / 2) {
    ...
    std::__choose_child<_AlgPolicy, true>(__child_i, __child, __len, __comp);
  ...
  return std::make_pair(std::move(__hole), __child);
}
